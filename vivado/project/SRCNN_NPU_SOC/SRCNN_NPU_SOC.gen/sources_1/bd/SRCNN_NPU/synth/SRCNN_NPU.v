...
//Date        : Fri Aug 28 09:39:19 2026
//Host        : user3-B80KV-AP35BKE running 64-bit Ubuntu 24.04.4 LTS
//Command     : generate_target SRCNN_NPU.bd
//Design      : SRCNN_NPU
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "SRCNN_NPU,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=SRCNN_NPU,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=12,numReposBlks=12,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=4,da_board_cnt=1,da_bram_cntlr_cnt=1,da_ps7_cnt=1,synth_mode=None}" *) (* HW_HANDOFF = "SRCNN_NPU.hwdef" *) 
module SRCNN_NPU
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire [15:0]AXI4_SRCNN_NPU_0_input_tile_bram_addr_o;
  wire AXI4_SRCNN_NPU_0_input_tile_bram_en_o;
  wire [14:0]DDR_addr;
  wire [2:0]DDR_ba;
  wire DDR_cas_n;
  wire DDR_ck_n;
  ...
  SRCNN_NPU_AXI4_SRCNN_NPU_0_2 AXI4_SRCNN_NPU_0
       (.input_tile_bram_addr_o(AXI4_SRCNN_NPU_0_input_tile_bram_addr_o),
        .input_tile_bram_en_o(AXI4_SRCNN_NPU_0_input_tile_bram_en_o),
        .input_tile_data_i(xlslice_0_Dout),
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x40000000 32 > SRCNN_NPU blk_mem_gen_0" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  SRCNN_NPU_axi_bram_ctrl_0_0 axi_bram_ctrl_0
  ...
  SRCNN_NPU_blk_mem_gen_0_0 blk_mem_gen_0
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_0_BRAM_PORTA_ADDR}),
        .addrb(xlconcat_0_dout),
        .clka(axi_bram_ctrl_0_BRAM_PORTA_CLK),
        .clkb(processing_system7_0_FCLK_CLK0),
        .dina(axi_bram_ctrl_0_BRAM_PORTA_DIN),
        .dinb(xlconstant_3_dout),
        .douta(axi_bram_ctrl_0_BRAM_PORTA_DOUT),
        .doutb(blk_mem_gen_0_doutb),
        .ena(axi_bram_ctrl_0_BRAM_PORTA_EN),
        .enb(AXI4_SRCNN_NPU_0_input_tile_bram_en_o),
        .rsta(axi_bram_ctrl_0_BRAM_PORTA_RST),
        .rstb(rst_ps7_0_50M_peripheral_reset),
        .wea(axi_bram_ctrl_0_BRAM_PORTA_WE),
        .web(xlconstant_2_dout));
  (* BMM_INFO_PROCESSOR = "arm > SRCNN_NPU axi_bram_ctrl_0" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  SRCNN_NPU_processing_system7_0_0 processing_system7_0
       (.DDR_Addr(DDR_addr),
        .DDR_BankAddr(DDR_ba),
        .DDR_CAS_n(DDR_cas_n),
        .DDR_CKE(DDR_cke),
  ...
  SRCNN_NPU_rst_ps7_0_50M_0 rst_ps7_0_50M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  SRCNN_NPU_xlconcat_0_0 xlconcat_0
       (.In0(xlconstant_0_dout),
        .In1(AXI4_SRCNN_NPU_0_input_tile_bram_addr_o),
        .In2(xlconstant_1_dout),
        .dout(xlconcat_0_dout));
  SRCNN_NPU_xlconstant_0_0 xlconstant_0
       (.dout(xlconstant_0_dout));
  SRCNN_NPU_xlconstant_1_0 xlconstant_1
       (.dout(xlconstant_1_dout));
  SRCNN_NPU_xlconstant_2_0 xlconstant_2
       (.dout(xlconstant_2_dout));
  SRCNN_NPU_xlconstant_3_0 xlconstant_3
       (.dout(xlconstant_3_dout));
  SRCNN_NPU_xlslice_0_0 xlslice_0
