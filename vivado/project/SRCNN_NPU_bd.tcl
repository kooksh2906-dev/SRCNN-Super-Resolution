...
################################################################
# This is a generated script based on design: SRCNN_NPU
#
...
user.org:user:AXI4_SRCNN_NPU:1.0\
...
\
  ...
  # Create instance: AXI4_SRCNN_NPU_0, and set properties
  set AXI4_SRCNN_NPU_0 [ create_bd_cell -type ip -vlnv user.org:user:AXI4_SRCNN_NPU:1.0 AXI4_SRCNN_NPU_0 ]
  set_property CONFIG.C_S00_AXI_ADDR_WIDTH {6} $AXI4_SRCNN_NPU_0
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins AXI4_SRCNN_NPU_0/S00_AXI]
  ...
  connect_bd_net -net AXI4_SRCNN_NPU_0_input_tile_bram_addr_o  [get_bd_pins AXI4_SRCNN_NPU_0/input_tile_bram_addr_o] \
  [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net AXI4_SRCNN_NPU_0_input_tile_bram_en_o  [get_bd_pins AXI4_SRCNN_NPU_0/input_tile_bram_en_o] \
  ...
  [get_bd_pins AXI4_SRCNN_NPU_0/s00_axi_aclk]
  ...
  [get_bd_pins AXI4_SRCNN_NPU_0/s00_axi_aresetn]
  ...
  [get_bd_pins AXI4_SRCNN_NPU_0/input_tile_data_i]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AXI4_SRCNN_NPU_0/S00_AXI/reg0] -force
